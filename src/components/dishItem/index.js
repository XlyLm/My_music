    ...
    return (
        <div className={Css.dj}>
            ...
            <div className={Css.img}>
                <Link to={`/album/${dish.id}`} className={"d_block"} title={dish.name}>
                    <Image fallback="data:image/png;base64,"
                           width={"100%"} src={dish.picUrl} />
                </Link>
                <a className={["iconfont",Css.play].join(" ")} href="#" title={"播放"}
                   onClick={(e)=>{e.preventDefault(); play(dish.id);}}>&#xec61;</a>
            </div>
            {/*文字*/}
            <div className={Css.content}>
                <p className={["font_h",Css.title].join(" ")}>
                    <Link to={`/album/${dish.id}`}>{dish.name}</Link>
                </p>
                <p className={"font_h"}>
                    {children}
                </p>
