...
import {getCollectArtist} from "@/api/user";
        ...
        <div className={Css.artist}>
            {
                artist !== null ?
                    <>
                        <Title title={`我的歌手(${artist.length})`}/>
                        {
                            artist.map((item,index)=>{
                                return <div key={index} className={["clearFix",Css.artistItem].join(" ")}>
                                    <div className={["float_l",Css.cover].join(" ")}>
